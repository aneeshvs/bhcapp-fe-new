...
interface PreviousSilGoalsProps {
  homeGoals?: SilGoal[];
  setHomeGoals?: React.Dispatch<React.SetStateAction<SilGoal[]>>;
  uuid?: string | null;
}

export default function HomeCareGoals({ homeGoals = [], setHomeGoals, uuid }: PreviousSilGoalsProps) {
  ...
  return (
    <div className="mb-4 mt-4 border border-gray-300 rounded shadow bg-white">
      <div className="flex justify-between items-center bg-gray-100 px-4 py-3">
        <h2 className="text-lg font-semibold text-heading">HOME CARE GOALS</h2>
        {uuid && (
          <button
            type="button"
