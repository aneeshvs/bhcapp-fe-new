...
interface PreviousSilGoalsProps {
  myGoals?: SilGoal[];
  setMyGoals?: React.Dispatch<React.SetStateAction<SilGoal[]>>;
  uuid?: string | null;
}

export default function SilGoals({ myGoals = [], setMyGoals, uuid }: PreviousSilGoalsProps) {
  ...
  return (
    <div className="mb-4 mt-4 border border-gray-300 rounded shadow bg-white">
      <div className="flex justify-between items-center bg-gray-100 px-4 py-3">
        <h2 className="text-lg font-semibold text-heading">SIL GOALS</h2>
        {uuid && (
          <button
            type="button"
      ...
      <div className="p-4">
        {myGoals.length === 0 ? (
          <p className="text-center text-gray-500 py-4">No SIL goals added yet.</p>
        ) : (
