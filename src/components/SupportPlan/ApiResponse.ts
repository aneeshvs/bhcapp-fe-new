export interface SupportApiResponse {
  ...
  developed_by: string;
  invited_but_not_participated: string;
  approval: Approval;
  representative_approval: SupportPlanRepresentative;
  care_approval	: CarePartner;
  keep_in_touch: KeepInTouch;
  non_responsive: NonResponsive;
  participant_detail: Participant;
  contact_detail: SupportContactDetails;
  contact_detail_secondary: SupportContactDetailsSecondary;
  support_funding: SupportPlanFundings;
  services: SupportPlanService[];
  supportplan_employee: EmployeeMatchingNeeds;
  my_goals: SupportPlanMyGoal[];
  living_arrangement: SupportPlanLivingArrangements;
  cultural_diversity: CulturalDiversities;
  general_health: SupportPlanGeneralHealth;
  medication_management: SupportPlanMedicationManagement;
  mobility_transfer: SupportPlanMobilityTransfers;
  falls_risk: SupportPlanFallsRisks;
  cognition: SupportPlanCognitions;
  behaviour_support: SupportPlanBehaviourSupports;
  personal_care: SupportPlanPersonalCares;
  continence: SupportPlanContinences;
  vision: SupportPlanVisions;
  hearing: SupportPlanHearings;
  skin_condition: SupportPlanSkinConditions;
  dietary: SupportPlanDietaries;
  pain_management: SupportPlanPain;
  social_connection: SupportPlanSocialConnections;
  home_maintenance: SupportPlanHomeMaintenances;
  financial_support: SupportPlanFinancialSupports;
  informal_support: SupportPlanInformalSupports;
  emergency_readiness: SupportPlanEmergencyReadiness;
  fire_heat_readiness: SupportPlanFireHeatReadiness;
  storm_flooding: SupportPlanStormFlooding;
...
export interface Participant {
  ...
  date_of_birth?: string | null; // stored as date string (ISO format)
  country_of_birth?: string | null;
  identify_as_aboriginal_or_torres_strait: number;
  gender?: string | null;
}
...
export interface SupportContactDetails {
  phone?: string | null;
  address?: string | null;
  is_rural_area?: number | null; // 1 = Yes, 0 = No
  mailing_address?: string | null;
  email?: string | null;
}


export interface SupportContactDetailsSecondary {
...
export interface SupportPlanLivingArrangements {
  reside_in?: string | null;
  reside_with?: string | null;
  home_safety_assessment_date?: string | null;
  is_home_suitable?: number | null;
  home_suitable_details?: string | null;
  at_risk_of_homelessness?: number | null;
  homelessness_details?: string | null;
}

export interface CulturalDiversities {
  is_lgbti?: number | null;
  lgbti_details?: string | null;
  is_separated_family?: number | null;
  separated_family_details?: string | null;
  has_cultural_events?: number | null;
  cultural_events_details?: string | null;
  has_past_events?: number | null;
  past_events_details?: string | null;
  has_non_disclosure_items?: number | null;
  non_disclosure_details?: string | null;
}
...
export interface SupportPlanEmergencyReadiness {
  emergency_at_risk_of_abuse?: number | null;
