...
const ActivityLog: React.FC<LogProps> = ({ logs }) => {
  ...
  const tableFieldsMap: Record<string, string[]> = {
    HousingSilSupport: [
      'housing_separate', 'change_sil_without_losing_home', 'tenancy_separate',
      'explained_to_me', 'participant_name', 'date', 'support_person', 'form_status', 'completion_percentage'
    ]
  };
