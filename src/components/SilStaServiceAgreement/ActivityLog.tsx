...
const ActivityLog: React.FC<LogProps> = ({ logs }) => {
  ...
  const tableFieldsMap: Record<string, string[]> = {
    SilStaServiceAgreement: [
      'ndis_plan_start_date', 'ndis_plan_end_date', 'service_agreement_start_date', 'service_agreement_end_date', 'form_status', 'completion_percentage'
    ],
    Parties: [
      'provider_name', 'abn', 'address', 'email', 'phone'
    ],
    ClientDetails: [
      'name', 'address', 'email', 'phone', 'ndis_number', 'funding_type'
    ],
    RepresentativeDetails: [
      'name', 'address', 'nature_of_legal_authority', 'email', 'phone'
    ],
    ScheduleOfSupports: [
      'support_services', 'ndis_funded_support', 'how_support_provided', 'non_funded_support', 'travel', 'program_of_supports', 'support_times', 'total', 'board_and_lodging_contributions', 'payment_terms'
    ],
    Signatures: [
      'provider_signature_name', 'provider_signature', 'provider_signature_date', 'client_signature_name', 'client_signature', 'client_signature_date', 'witness_name', 'witness_signature', 'witness_signature_date'
    ]
  };
