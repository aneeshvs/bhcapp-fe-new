...
const ActivityLog: React.FC<LogProps> = ({ logs }) => {
  ...
  const tableFieldsMap: Record<string, string[]> = {
    ...
    ReviewSignatures: [
      'signer_type', 'participant_name', 'participant_date', 'participant_signature',
      'representative_name', 'representative_relation', 'representative_date', 'representative_signature',
      'guardian_nominee_name', 'guardian_nominee_date', 'guardian_nominee_signature',
      'key_team_member_name', 'key_team_member_date', 'key_team_member_signature'
    ]
  };
